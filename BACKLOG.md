...
- [~] **Sprachversionen** (in Arbeit): Umschalter-Gerüst (19.07.2026) + **Englisch VOLLSTÄNDIG
  ...
  **Live: DE · EN · RU · UK · TR** (je 25 Seiten, alle 4 gegenseitig im Umschalter verlinkt, hreflang, SW v32, Sitemap). **Als Nächstes: IT fertigstellen** (Pilot `it/index.html` da, 24 Seiten + Verdrahtung offen — Prozess in **docs/HANDOVER-i18n.md**), dann PL, ES, AR (RTL!), FR … aus dem Set.
